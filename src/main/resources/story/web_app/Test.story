...
When I enter `lamoda.kz` in field located by `<search-input-field>`
When I wait until element located by `<search-button>` appears
When I click on element located by `<search-button>`
Then number of elements found by `linkUrlPart(https://www.lamoda.kz/)->filter.textPart(Lamoda)` is equal to `1`
